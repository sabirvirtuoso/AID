    ...
    A.extend(A.fn,{
        pstrength:function(B){
            var B=A.extend({
                ...
                scores:[10,15,30,40],
                common:["password","sex","god","123456","123","liverpool","letmein","qwerty","monkey","!@#$%","1234","12345","qwerty","QWERTY","asdf"],
                minchar:6
            },B);
        ...
        runPassword:function(D,F,C){
            ...
            if(nPerc==-200){
                ...
                $('button#change_password').attr("disabled", "disabled");
                A(B).css({
                    width:"0%"
                })
            }else{
                        ...
                        if(nPerc>C.scores[0]&&nPerc<=C.scores[1]){
                            ...
                            if(nPerc>C.scores[1]&&nPerc<=C.scores[2]){
                                ...
                                strText=C.verdects[2];
                                    ...
                                    $("button#change_password").removeAttr("disabled");
